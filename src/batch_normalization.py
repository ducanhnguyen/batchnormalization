...
class NeuralNetwork:
    ...
    def fit(self, Xtrain, ytrain, Xval, yval, epoch=100, learning_rate=0.001, batch_size=50):
        ...
        Yval = src.utils.convert2indicator(yval)
        N, D = Xtrain.shape
        ...
        self.plotError(trainingErrors, validationErrors, epoches)
        self.plotAccuracy(trainingAccuracies, validationAccuracies, epoches)
